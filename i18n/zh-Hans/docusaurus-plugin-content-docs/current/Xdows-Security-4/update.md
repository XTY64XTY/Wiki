...
- 页面：
    - 删除不需要的代码
    - 点击设置按钮增加旋转动画![Update-Beta7-ColorDialog](./PNG/Update-Beta7-SettingsButtonAnimation.gif)效果图
- 设置：
    - 增加 `常见问题` 页面
    - 增加 `配色管理` 功能![Update-Beta7-ColorDialog](./PNG/Update-Beta7-ColorDialog.png)效果图
- 客户端：初始功能
- Xdows UI：
    - 增加手机版UI
    - 内嵌图标字体
...
- Xdows UI
    ...
    - 添加 `信息框` 组件
    - 添加 `选择框` 组件
    - 增加 `菜单` 组件背景亚克力效果![Update-Beta6-Menu](./PNG/Update-Beta6-Menu.png)效果图
    - 增加部分组件的禁用样式
    - 优化 `滑动按钮` 组件动画
