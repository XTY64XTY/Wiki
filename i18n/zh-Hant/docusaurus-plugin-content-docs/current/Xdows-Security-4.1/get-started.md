...
| 體系結構 | 連結 | 備註 |
|---------|------|------|
| ARM64 | [https://aka.ms/vc14/vc_redist.arm64.exe](https://aka.ms/vc14/vc_redist.arm64.exe) | 最新受支援 ARM64 版本的永久連結 |
| X86 | [https://aka.ms/vc14/vc_redist.x86.exe](https://aka.ms/vc14/vc_redist.x86.exe) | 最新受支援 x86 版本的永久連結 |
| X64 | [https://aka.ms/vc14/vc_redist.x64.exe](https://aka.ms/vc14/vc_redist.x64.exe) | 最新受支援 x64 版本的永久連結。X64 可再發行套件包含 ARM64 和 X64 二進位檔案。當 X64 可再發行套件安裝在 ARM64 裝置上時，可以透過此套件輕鬆安裝所需的 Visual C++ ARM64 二進位檔案。 |
