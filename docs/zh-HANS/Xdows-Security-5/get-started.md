...
| Xdows Model | 基于 LightGBM 的高精度扫描引擎，支持 Flash/Standard/Pro 三种模式 | 全部开源 |
...
该项目签署了 MIT 授权许可，详情请参阅 [LICENSE](https://github.com/XTY64XTY/Xdows-Security-5/blob/main/LICENSE.txt)
