...
description: Xdows Security 5 是基於 WinUI 3 和 C# 構建的開源防毒軟體，提供下載、常見問題、掃描引擎和編譯執行說明。
---
...
Xdows Security 5 是一個基於 `WinUI3` + `C#` 技術構建的防毒軟體，完全開源並使用 MIT 協議。
...
| Xdows Model | 基於 LightGBM 的高精度掃描引擎，支援 Flash/Standard/Pro 三種模式 | 全部開源 |
...
該專案簽署了 MIT 授權許可，詳情請參閱 [LICENSE](https://github.com/XTY64XTY/Xdows-Security-5/blob/main/LICENSE.txt)
