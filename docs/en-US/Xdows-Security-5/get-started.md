...
Xdows Security 5 is an antivirus software built using `WinUI 3` and `C#`, fully open source under the MIT License.
...
### Xdows Model engine cannot be used
...
| Xdows Model | High-precision scan engine based on LightGBM, supports Flash/Standard/Pro modes | Fully open source |
