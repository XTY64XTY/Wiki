    ...
    'Xdows-Security-4.1': [
      {
        ...
        lines: [
          'This version is outdated. It is recommended to view the latest <a href="/Xdows-Security-5/get-started">Xdows Security 5</a> version.',
        ],
      },
      {
        type: 'info',
    ...
    'Xdows-Security-4.1': [
      {
        ...
        title: '注意',
        lines: [
          '该版本已过时。建议查看最新的 <a href="/zh-Hans/Xdows-Security-5/get-started">Xdows Security 5</a> 版本。',
        ],
      },
      {
        type: 'info',
    ...
    'Xdows-Security-4.1': [
      {
        ...
        title: '注意',
        lines: [
          '該版本已過時。建議查看最新的 <a href="/zh-Hant/Xdows-Security-5/get-started">Xdows Security 5</a> 版本。',
        ],
      },
      {
        type: 'info',
